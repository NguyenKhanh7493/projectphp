    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <div class="user-profile">
            <div class="dropdown user-pro-body">
                ...
                <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?= $_SESSION['fullname']?> <span class="caret"></span></a>
        ...
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="<?=base_url?>/admin/index.php" class="waves-effect active"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu"> Trang chủ </span></a></li>
